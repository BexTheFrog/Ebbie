                      ...
                      children: reviews.map((t) {
                        ...
                        return CustomReviewCard(
                          ...
                          hasStudy: (String? selectedMood) async {
                            final tarefaId = t['id'];
                            if (selectedMood != null && userId != null) {
                              ...
                              final gaveCoin = tarefaData.isNotEmpty
                                  ? tarefaData[0]['gaveCoin'] ?? 0
                                  : 0;
                              ...
                              if (gaveCoin == 0) {
                                ...
                                if (userData.isNotEmpty) {
                                  final carteiraAtual =
                                      userData[0]['carteira'] ?? 0;
                                  final novaCarteira = carteiraAtual + moedas;

                                  // Atualiza carteira no banco
                                  ...
                                  // Atualiza UI (supondo que você tenha um ValueNotifier<int> coinNotifier)
                                  coinNotifier.value = novaCarteira;
                                }
                                ...
                                // Se já deu coin antes, apenas atualiza o status
                                await dbHelper.update(
                                  'tarefa',
                                  {'status': selectedMood, 'wasReviewd': 1},
                                  'id = ?',
                                  [tarefaId],
                                );
                              }
